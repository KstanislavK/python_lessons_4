...
from common.params import DEFAULT_PORT, DEFAULT_ADDRESS, \
...
def get_message_from_server(message):
    if ACTION in message and SENDER in message and MESSAGE_TEXT in message:
...
@log
def create_presence(account_name='Mavrin'):
    out = {
        ACTION: PRESENCE,
        TIME: time.time(),
        USER: {
